Feature:  E2E_Placing Order_Transaction
  ...
  @E2E
  Scenario Outline: E2E_PlaceOrder_Transaction: <firstname> <lastname> | <products_to_add>
    ...
    Examples:
      ...
      | practice@qabrains.com | Password123 | Jenny     | Lauren   | Sample Shoe Name,Sample Trouser Name                   |
      | test@qabrains.com     | Password123 | Debby     | Field    | Sample Trouser Name                                    |


  @E2E
  Scenario Outline: E2E_Submission_Validation: <firstname> <lastname> | <products_to_add>
    Given User is on the login page
    And User logins into the application using "<email>" and "<password>"
    And User lands on the Dashboard page to view items
    And User selects the products "<products_to_add>" and adds them into cart
    ...
    Examples:
      | email                 | password    | firstname | lastname | products_to_add                                        |
      | test@qabrains.com     | Password123 | Jacob     | Hill     | Sample Shirt Name                                      |
      | practice@qabrains.com | Password123 | Abigail   | Reev     | Sample Shirt Name,Sample Shoe Name,Sample Trouser Name |
      | student@qabrains.com  | Password123 | Justin    | Rich     | Sample Shoe Name,Sample Trouser Name                   |
